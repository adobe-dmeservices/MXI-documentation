...
Attributes: [href, resid, source, href-resid, source\_resid]
...
Attibures: id, name, version, [icon, force-quit, ismultilingual, name\_resid, type, plugin-manager-type]
...
Required. The name of the extension, displayed in Extension Manager. A VARCHAR data type with a limit of 255 characters. You can localize the name using the name\_resid attribute.
